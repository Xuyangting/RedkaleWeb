...
public abstract class OssRetCodes {
    ...
    //------------------------------------------------------------------------------------------------------------
    @RetLabel("名称重复")
    public static final int RET_NAME_REPEATED = 50020001;
    
    @RetLabel("内部错误")
    public static final int RET_INTERAL_ERROR = 50020002;

    @RetLabel("用例编号不存在")
    public static final int RET_TESTINTERFACE_ERROR = 50020003;
    
    @RetLabel("集合编号不存在")
    public static final int RET_TESTSUITE_ERROR = 50020004;
    
    @RetLabel("任务编号不存在")
    public static final int RET_TESTJOB_ERROR = 50020005;
