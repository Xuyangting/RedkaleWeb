$(document).ready(function () {
    ...
    $.get("/base.html", {}, function (data) {
        $("#footer").html('<span class="text-right">Copyright &copy; 2017. Automation testing team, YouYu Technology, Shenzhen.</span>' + data);
    });
    ...
    window.openModule = function (url, moduleid) {
        ...
        $.get(url, {}, function (data) {
            ...
            if($('window').height() - maincontainer.position().top < maincontainer.height()) maincontainer.resize();
        });
    };
    //-------------------------- status ----------------------------------------------------------
    ...
    //-------------------------- topbar ----------------------------------------------------------
    var topbarhtml = [];
    topbarhtml.push('<div class="topbar-left"><div class="text-center"><p class="logo">质量中心</p></div></div>');
    ...
    menuhtml.push('    <li class="first_active"><a href="/index.html"><i class="fa fa-home"></i>  <span>中心首页</span></a></li>');
